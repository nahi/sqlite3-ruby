...
_wrap_CallbackData_proc_set(int argc, VALUE *argv, VALUE self) {
  ...
  if (!SWIG_IsOK(res1)) {
    SWIG_exception_fail(SWIG_ArgError(res1), "in method '" "proc" "', argument " "1"" of type '" "struct CallbackData *""'"); 
  }
...
_wrap_CallbackData_proc2_set(int argc, VALUE *argv, VALUE self) {
  ...
  res1 = SWIG_ConvertPtr(self, &argp1,SWIGTYPE_p_CallbackData, 0 |  0 );
  if (!SWIG_IsOK(res1)) {
    SWIG_exception_fail(SWIG_ArgError(res1), "in method '" "proc2" "', argument " "1"" of type '" "struct CallbackData *""'"); 
  }
  arg1 = (struct CallbackData *)(argp1);
  arg2 = argv[0];
...
_wrap_CallbackData_data_set(int argc, VALUE *argv, VALUE self) {
  ...
  res1 = SWIG_ConvertPtr(self, &argp1,SWIGTYPE_p_CallbackData, 0 |  0 );
  if (!SWIG_IsOK(res1)) {
    SWIG_exception_fail(SWIG_ArgError(res1), "in method '" "data" "', argument " "1"" of type '" "struct CallbackData *""'"); 
  }
  arg1 = (struct CallbackData *)(argp1);
  arg2 = argv[0];
...
_wrap_new_CallbackData(int argc, VALUE *argv, VALUE self) {
  ...
  result = (struct CallbackData *)(struct CallbackData *) calloc(1, sizeof(struct CallbackData));DATA_PTR(self) = result;
...
static swig_type_info _swigt__p_CallbackData = {"_p_CallbackData", "struct CallbackData *", 0, 0, (void*)0, 0};
...
static swig_type_info _swigt__p_void = {"_p_void", "void *|RUBY_VALBLOB *", 0, 0, (void*)0, 0};
